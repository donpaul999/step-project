...
public final class FindMeetingQueryTest {
  ...
  @Test
  public void everyAttendeeIsConsideredOptionalHasNoEffect() {
    // Have each person have different events. We should see two options because each person has
    // split the restricted times.
    //         : |--------------C--------------|
    // Events  :       |--A--|     |--B--|
    // Day     : |-----------------------------|
    // Options : |--1--|     |--2--|     |--3--|
    // Attendee C is optional and he has an all-day event. 
  ...
  @Test
  public void everyAttendeeIsConsideredOptionalHasEffect() {
    // Have each person have different events. We should see two options because each person has
    // split the restricted times.
    // Optional:          |----C---|
    // Events  :       |--A--|     |--B--|
  ...
  public void notEnoughRoom() {
   ...
   public void onlyOptionalAttendees() {
    // We have only 2 optional attendees
    //
    // Events  : |--A--|     |---B-----|
    // Day     : |---------------------|
    // Options :
   ...
   @Test
   public void onlyOptionalAttendeesAllDayAvailable() {
    // We have only 2 optional attendees
    //
    // Events  : |--A--||-------B------|
    // Day     : |---------------------|
